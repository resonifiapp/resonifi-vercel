...
import logo from "../assets/resonifi-logo-landing.png"; // spiral + white wordmark

export default function Landing() {
  const navigate = useNavigate();

  // Page is inside AppShell (maxWidth ~500px),
  // so we design this as a single-column, mobile-first layout.
  const page = {
    minHeight: "100vh",
    background:
  ...
  // Match AppShell width so nothing overflows horizontally
  const frame = {
    width: "100%",
    maxWidth: "500px",
    margin: "0 auto",
  ...
  // Slightly smaller so the full wordmark fits nicely
  const logoImg = {
    height: "120px",
    width: "auto",
    objectFit: "contain",
